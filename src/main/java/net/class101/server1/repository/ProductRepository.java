...
public class ProductRepository {
	...
	private List<Product> products = List.of(
			...
			, new Product(6, "55527", TypeCode.CLASS, "코바늘로 인형을 만들자! 시은맘의 꼼지락 작업실", 299500, DefaultValue.AMOUNT_INF)
			, new Product(7, "2344", TypeCode.CLASS, "일상 유튜버 슛뚜의 감성을 그대로. 영화같은 브이로그 제작법", 184500, DefaultValue.AMOUNT_INF)
			...
			, new Product(10, "53144", TypeCode.CLASS, "여행 드로잉, 꿈만 꾸지 마세요. 핀든아트와 여행, 그리다", 249500, DefaultValue.AMOUNT_INF)
			, new Product(11, "78311", TypeCode.CLASS, "사각사각 손글씨의 낭만, 펜크래프트의 한글 정자체 펜글씨", 209500, DefaultValue.AMOUNT_INF)
			, new Product(12, "97166", TypeCode.KIT, "이렇게 멋진 수채화 키트, 어때요? 클래스101과 고넹이화방이 기획한 3가지 수채화 키트", 96900, 5)
			, new Product(13, "83791", TypeCode.CLASS, "월급으로 만족하지 못하는 분들을 위한 아마존/이베이 입문", 178500, DefaultValue.AMOUNT_INF)
			...
			, new Product(16, "96558", TypeCode.CLASS, "사진 입문자를 위한 쉽게 배우고 빨리 써먹는 사진과 라이트룸", 234500, DefaultValue.AMOUNT_INF)
			, new Product(17, "42031", TypeCode.KIT, "나만의 음악을 만들기 위한 장비 패키지", 209000, 2)
			, new Product(18, "45947", TypeCode.CLASS, "일러스트레이터 집시의 매력적인 얼굴 그리기", 249500, DefaultValue.AMOUNT_INF)
			, new Product(19, "74218", TypeCode.CLASS, "나만의 문방구를 차려요! 그리지영의 타블렛으로 굿즈 만들기", 191600, DefaultValue.AMOUNT_INF)
